                        ...
                        <li class="selected">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td class="operation">
                                        <!-- #############################这里变了#############################-->
                                        <a href="#" type="button" class="btn btn-warning btn-xs">删除宝贝</a>
                                        <a href="#" type="button" class="btn btn-success btn-xs js-btn-message">查看留言</a>
                                        <!-- #############################这里变了END#############################-->
                                    </td>
                                </tr>
                                </tbody>
                            ...
                            <div class="js-table-message" style="display: none;">
                                <table class="table table-striped text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>Mark</td>
                                        <td>Otto</td>
                                        <td><a href="#" type="button" class="btn btn-primary btn-xs">完成交易</a></td>
                                    </tr>
                                    <tr>
                                        <td>Mark</td>
                                        <td>Jacob</td>
                                        <td>ThorntonThorntonThorntonThorntonThorntonThorntonThorntonThorntonThorntonThorntonThorntonThorntonThorntonThorntonThorntonThorntonThornton</td>
                                        <td><a href="#" type="button" class="btn btn-primary btn-xs">完成交易</a></td>
                                    </tr>
                                    <tr>
                                        <td>Mark</td>
...
<script>
  $(".js-btn-message").on("click", function (){
    $(this).closest("table").closest("li").find(".js-table-message").fadeToggle("normal","linear");
  })
</script>
</body>
</html>
